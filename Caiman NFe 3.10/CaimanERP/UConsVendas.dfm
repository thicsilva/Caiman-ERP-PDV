object FrmConsVendas: TFrmConsVendas
  ...
  object QConsVendas: TFDQuery
    ...
    SQL.Strings = (
      'SELECT V.*, C.NOME_CLI, T.NOME_TPV, VE.NOME_VEND,'
    ...
    object QConsVendasOBS: TStringField
      FieldName = 'OBS'
      Origin = '"VENDAS"."OBS"'
      Size = 255
    end
  ...
  object QinsItensNotaFiscal: TFDQuery
    ...
    SQL.Strings = (
      ...
      'CST, QUANT, UNIT, ALIQ, COD_EMP, COD_GRP, ALIQ_IPI,'
        ...
        'REDUCAO_ICMS, COD_CFO, SUB_TRIBUTARIA, VR_AGREGADO,         ALIQ' +
        'UOTA_FORA_ESTADO, UNIDADE, VALOR_TOTAL, BASE_CALCULO, VALOR_ICMS' +
        ', BASE_SUBTRIB, VALOR_SUBTRIB, VALOR_IPI, CLASSIFICACAO_FISCAL) ' +
        '                        '
