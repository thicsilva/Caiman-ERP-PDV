object FrmDAVOrdemServico: TFrmDAVOrdemServico
  Left = 262
  Top = 202
  ...
  object StatusBar1: TStatusBar
    ...
    Panels = <
      ...
      item
        Text = '[F5] Fechar Ordem Servi'#231'o'
        Width = 180
      end
      item
        Text = '[F9] Buscar Itens OS'
        Width = 180
      end
      item
  ...
  object Panel1: TPanel
    ...
    object Panel3: TPanel
      ...
      object BtnConsMarca: TsSpeedButton
        Left = 68
        Top = 144
        Width = 23
        Height = 21
      ...
      object Label29: TLabel
        ...
        Width = 93
        Height = 13
        Caption = 'N'#250'mero Fabrica'#231#227'o'
      end
      ...
      object EdtCodMarca: TEdit
        ...
        ShowHint = True
        TabOrder = 7
        OnEnter = EdtCodMarcaEnter
        OnExit = EdtCodMarcaExit
        OnKeyDown = EdtCodMarcaKeyDown
        OnKeyPress = EdtCodcliKeyPress
      end
      ...
      object GBTotal: TGroupBox
        ...
        object EdtTotalServicos: TCurrencyEdit
          Left = 96
          Top = 30
          Width = 89
          Height = 18
    ...
    object Panel4: TPanel
      ...
      object PanelJuntarOS: TPanel
        ...
        object Label1: TLabel
          ...
          Width = 125
          Height = 13
          Caption = 'N'#250'mero Ordem de Servi'#231'o'
        end
        object EdtNumeroOS: TEdit
          Left = 16
          Top = 24
          Width = 153
          Height = 21
  ...
  object ImageList: TImageList
    ...
    Left = 520
    Bitmap = {
      494C010104000900100019001900FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object QBuscaItens: TFDQuery
    ...
    SQL.Strings = (
      'SELECT I.*, P.NOME_PRO, P.DESC_CUPOM,  V.NOME_VEND, T.SERVICO'
    ...
    object QBuscaItensCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'ITENS_ORDEM_SERVICO.CODIGO'
      Required = True
    end
    object QBuscaItensORDEM: TIntegerField
      FieldName = 'ORDEM'
      Origin = 'ITENS_ORDEM_SERVICO.ORDEM'
      Required = True
    end
    object QBuscaItensCOD_PRO: TIntegerField
      FieldName = 'COD_PRO'
      Origin = 'ITENS_ORDEM_SERVICO.COD_PRO'
      Required = True
    end
    object QBuscaItensDESCONTO: TBCDField
      FieldName = 'DESCONTO'
      Origin = 'ITENS_ORDEM_SERVICO.DESCONTO'
      Required = True
      DisplayFormat = ',#0.00'
      Precision = 18
      Size = 2
    ...
    object QBuscaItensCOD_EMP: TIntegerField
      FieldName = 'COD_EMP'
      Origin = 'ITENS_ORDEM_SERVICO.COD_EMP'
      Required = True
    end
    object QBuscaItensCOD_VEND: TIntegerField
      FieldName = 'COD_VEND'
      Origin = 'ITENS_ORDEM_SERVICO.COD_VEND'
      Required = True
    end
    object QBuscaItensQUANT: TBCDField
      FieldName = 'QUANT'
      Origin = 'ITENS_ORDEM_SERVICO.QUANT'
      Required = True
      DisplayFormat = ',#0.000'
      Precision = 18
      Size = 3
    ...
    object QBuscaItensVALOR: TBCDField
      FieldName = 'VALOR'
      Origin = 'ITENS_ORDEM_SERVICO.VALOR'
      Required = True
      DisplayFormat = ',#0.00'
      Precision = 18
      Size = 3
    ...
    object QBuscaItensPRODUTO_PROMOCAO: TStringField
      ...
      Origin = 'ITENS_ORDEM_SERVICO.PRODUTO_PROMOCAO'
      Required = True
      FixedChar = True
      Size = 1
    end
    object QBuscaItensCANCELADO: TIntegerField
      FieldName = 'CANCELADO'
      Origin = 'ITENS_ORDEM_SERVICO.CANCELADO'
      Required = True
    end
    ...
    object QBuscaItensNOME_VEND: TStringField
      FieldName = 'NOME_VEND'
  ...
  object QInsertOS: TFDQuery
    Connection = DM.IBDatabaseServer
    Transaction = IBTROS
    SQL.Strings = (
      'SELECT *'
      'FROM SP_INSERT_ORDEM_SERVICO(:DATA_ABERTURA ,'
      ':CODIGO_MARCA, :CODIGO_MODELO, :ANO_FABRICACAO,'
      ':PLACA, :RENAVAM, :COD_CLI, :COD_TPV, :NUMERO_SERIE,'
      ':COD_CAI, :COD_EMP)')
    Left = 536
    Top = 200
    ParamData = <
    ...
    object QInsertOSCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'SP_INSERT_ORDEM_SERVICO.CODIGO'
    end
    object QInsertOSSEQUENCIA: TLargeintField
      FieldName = 'SEQUENCIA'
      Origin = 'SP_INSERT_ORDEM_SERVICO.SEQUENCIA'
    end
  end
