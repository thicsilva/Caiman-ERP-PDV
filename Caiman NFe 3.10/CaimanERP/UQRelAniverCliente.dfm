object FrmQRelAniverCliente: TFrmQRelAniverCliente
  Left = 168
  Top = 338
  Caption = 'FrmQRelAniverCliente'
  ClientHeight = 197
  ClientWidth = 798
  Color = clBtnFace
  ...
  object QRAniver: TQuickRep
    ...
    DataSet = FrmConsAniversario.QCliente
    ...
    object PageHeaderBand1: TQRBand
      ...
      object QRLTitulo: TQRLabel
        ...
        AlignToBand = False
        AutoSize = False
        Caption = 'Relatorio de Cliente [Aniversariantes] no Per'#237'odo'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
