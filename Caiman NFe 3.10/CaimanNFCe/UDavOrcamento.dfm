object FrmDavOrcamento: TFrmDavOrcamento
  Left = 300
  Top = 94
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'DAV [Or'#231'amento]'
  ClientHeight = 599
  ClientWidth = 719
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Panel4: TPanel
      ...
      object PanelJuntarOrcamento: TPanel
        Left = 201
        Top = 192
        Width = 281
        Height = 73
        ...
        object Label1: TLabel
          ...
          Width = 107
          Height = 13
          Caption = 'Numero do Or'#231'amento'
        end
        object EdtSeqOrcamento: TEdit
          Left = 16
          Top = 24
          Width = 153
          Height = 21
  ...
  object StatusBar1: TStatusBar
    ...
    Panels = <
      ...
      item
        Text = '[F5] Fechar Or'#231'amento'
        Width = 180
      end
      item
        Text = '[F9] Juntar Or'#231'amento'
        Width = 180
      end
      item
  ...
  object QBuscaItens: TFDQuery
    ...
    Transaction = IBTROrcamento
    OnCalcFields = QBuscaItensCalcFields
    SQL.Strings = (
      'SELECT I.*, P.NOME_PRO, P.DESC_CUPOM, U.DESCRICAO'
  ...
  object IBTROrcamento: TFDTransaction
    Connection = DM.IBDatabaseServer
    Left = 200
    Top = 456
  end
  object IBSQLOrcamento: TFDQuery
    Connection = DM.IBDatabaseServer
    Transaction = IBTROrcamento
    Left = 96
    Top = 456
  ...
  object QInsOrcamento: TFDQuery
    ...
    SQL.Strings = (
      'SELECT *'
        ...
        'FROM SP_INSERT_ORCAMENTO(:DATA, :CODCLI, :CODTPV, :CODEMP, :CODV' +
        'END, :CAIXA)')
    Left = 432
    Top = 456
    ParamData = <
  ...
  object ImageList: TImageList
    ...
    Top = 40
    Bitmap = {
      494C010104000900180019001900FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
