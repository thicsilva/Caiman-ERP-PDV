object FrmQRelVendasLucro: TFrmQRelVendasLucro
  Left = 250
  Top = 281
  Caption = 'FrmQRelVendasLucro'
  ClientHeight = 189
  ClientWidth = 798
  Color = clBtnFace
  ...
  object QRVenda: TQuickRep
    ...
    DataSet = FrmRelVendasLucro.QRelVendas
    ...
    object DetailBand1: TQRBand
      ...
      object QRExpr3: TQRExpr
        ...
        ResetAfterPrint = False
        Transparent = False
        Expression = 'IF(TOTALCUSTO = 0,100,((TOTAL - TOTALCUSTO) / TOTALCUSTO) * 100)'
        Mask = ',#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 10
    ...
    object SummaryBand1: TQRBand
      ...
      object QRExpr5: TQRExpr
        ...
        ResetAfterPrint = False
        Transparent = False
        Expression = 'SUM(TOTAL - TOTALCUSTO)'
        Mask = ',#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 10
