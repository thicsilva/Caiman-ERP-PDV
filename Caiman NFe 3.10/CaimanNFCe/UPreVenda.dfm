object FrmPreVenda: TFrmPreVenda
  ...
  object StatusBar1: TStatusBar
    ...
    Panels = <
      ...
      item
        Text = '[F5] Fechar Pr'#233'-venda'
        Width = 180
      end
      item
        Text = '[F9] Juntar Pr'#233'-Venda'
        Width = 180
      end
      item
  ...
  object IBSQLPre: TFDQuery
    Connection = DM.IBDatabaseServer
    Transaction = IBTRPreVenda
    Left = 80
    Top = 456
  end
  object QInsPreVenda: TFDQuery
    Connection = DM.IBDatabaseServer
    Transaction = IBTRPreVenda
    SQL.Strings = (
      'SELECT *'
      
        'FROM SP_INSERT_PREVENDA(:DATA, :CODCLI, :CODTPV, :CODEMP, :HORAP' +
        'RE, :DOC, :CODVEND)')
    Left = 384
    Top = 456
    ParamData = <
    ...
    object QInsPreVendaCODPRE: TIntegerField
      FieldName = 'CODPRE'
      Origin = 'INS_PRE_VENDA.CODPRE'
    end
    object QInsPreVendaSEQUENCIA: TLargeintField
      FieldName = 'SEQUENCIA'
      Origin = 'SP_INSERT_PREVENDA_PAF.SEQUENCIA'
    end
  end
  ...
  object QItensPreVenda: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT I.*, P.DESC_CUPOM, P.ICMS_CF_EST, P.CODIGO_BARRA_PRO, U.D' +
        'ESCRICAO'
      'FROM ITENS_PRE_VENDA I'
      'INNER JOIN PRODUTO P'
      'ON (I.COD_PRO = P.COD_PRO)'
