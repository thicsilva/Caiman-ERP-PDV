object FrmRelExtratoFor: TFrmRelExtratoFor
  Left = 388
  Top = 247
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Relat'#243'rio de Extrato de Fornecedor'
  ClientHeight = 180
  ClientWidth = 392
  Color = clBtnFace
  ...
  object QRelExt: TFDQuery
    Connection = DM.IBDatabase
    Transaction = DM.IBTransaction
    SQL.Strings = (
      
        'SELECT COD_CPT, COD_EMP, DATA_CTP, DESCONTO_CTP, ACRESCIMO_CTP, ' +
        'DTPAGTO_CTP, DTVENCTO_CTP, NUM_DOC_CTP, SEQUENCIA_CTP, VALOR_CTP' +
        ', VALOR_PAGO_CTP'
      'FROM CONTAS_PAGAR')
    Left = 288
    Top = 56
    object QRelExtCOD_CPT: TIntegerField
      FieldName = 'COD_CPT'
      Origin = 'CONTAS_PAGAR.COD_CPT'
      Required = True
    end
    object QRelExtCOD_EMP: TIntegerField
      FieldName = 'COD_EMP'
      Origin = 'CONTAS_PAGAR.COD_EMP'
      Required = True
    end
    object QRelExtDATA_CTP: TDateField
      FieldName = 'DATA_CTP'
      Origin = 'CONTAS_PAGAR.DATA_CTP'
      Required = True
    end
    object QRelExtDESCONTO_CTP: TBCDField
    ...
    object QRelExtACRESCIMO_CTP: TBCDField
    ...
    object QRelExtVALOR_PAGO_CTP: TBCDField
