object FrmQRelDespesaReceita: TFrmQRelDespesaReceita
  Left = 202
  Top = 143
  Caption = 'FrmQRelDespesaReceita'
  ClientHeight = 441
  ClientWidth = 812
  Color = clBtnFace
  ...
  object QRVenda: TQuickRep
    ...
    DataSet = FrmRelVendasLucro.QRelDespRec
    ...
    object DetailBand1: TQRBand
      ...
      object QRExpr3: TQRExpr
        ...
        ResetAfterPrint = False
        Transparent = False
        Expression = 'IF(DESPESA = 0,100,((RECEITA - DESPESA) / DESPESA) * 100)'
        Mask = ',#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 10
    ...
    object SummaryBand1: TQRBand
      ...
      object QRExpr5: TQRExpr
        ...
        ResetAfterPrint = False
        Transparent = False
        Expression = 'SUM(RECEITA - DESPESA)'
        Mask = ',#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 10
      ...
      object QRExpr6: TQRExpr
        ...
        Transparent = False
        Expression = 
          'IF(SUM(DESPESA) = 0,100,((SUM(RECEITA) - SUM(DESPESA)) / SUM(DES' +
          'PESA)) * 100)'
        Mask = ',#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
