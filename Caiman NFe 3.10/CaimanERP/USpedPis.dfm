object frmSpedPis: TfrmSpedPis
  ...
  object CheckMatrizFilial: TCheckBox
    Left = 17
    Top = 90
    Width = 153
    Height = 17
    Caption = 'Gerar Matriz Filial'
    TabOrder = 3
  end
  ...
  object Empresas: TFDQuery
    ...
    SQL.Strings = (
      'select * from empresa order by cod_emp')
    Left = 112
    Top = 160
    object EmpresasCOD_EMP: TIntegerField
      FieldName = 'COD_EMP'
      Origin = '"EMPRESA"."COD_EMP"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object EmpresasRAZAO_EMP: TStringField
      FieldName = 'RAZAO_EMP'
      Origin = '"EMPRESA"."RAZAO_EMP"'
      Required = True
      Size = 50
    end
    object EmpresasEND_EMP: TStringField
      FieldName = 'END_EMP'
      Origin = '"EMPRESA"."END_EMP"'
      Size = 50
    end
    object EmpresasBAI_EMP: TStringField
      FieldName = 'BAI_EMP'
      Origin = '"EMPRESA"."BAI_EMP"'
      Size = 30
    end
    object EmpresasCID_EMP: TStringField
      FieldName = 'CID_EMP'
      Origin = '"EMPRESA"."CID_EMP"'
      Size = 30
    end
    object EmpresasCEP_EMP: TStringField
      FieldName = 'CEP_EMP'
      Origin = '"EMPRESA"."CEP_EMP"'
      FixedChar = True
      Size = 9
    end
    object EmpresasEST_EMP: TStringField
      FieldName = 'EST_EMP'
      Origin = '"EMPRESA"."EST_EMP"'
      FixedChar = True
      Size = 2
    end
    object EmpresasINSC_EMP: TStringField
      FieldName = 'INSC_EMP'
      Origin = '"EMPRESA"."INSC_EMP"'
    end
    object EmpresasTEL_EMP: TStringField
      FieldName = 'TEL_EMP'
      Origin = '"EMPRESA"."TEL_EMP"'
      Size = 13
    end
    object EmpresasFAX_EMP: TStringField
      FieldName = 'FAX_EMP'
      Origin = '"EMPRESA"."FAX_EMP"'
      Size = 13
    end
    object EmpresasNOME_EMP_ETIQUETA: TStringField
      FieldName = 'NOME_EMP_ETIQUETA'
      Origin = '"EMPRESA"."NOME_EMP_ETIQUETA"'
      Size = 15
    end
    object EmpresasNUMERO_EMP: TStringField
      FieldName = 'NUMERO_EMP'
      Origin = '"EMPRESA"."NUMERO_EMP"'
      Size = 10
    end
    object EmpresasRESP_EMP: TStringField
      FieldName = 'RESP_EMP'
      Origin = '"EMPRESA"."RESP_EMP"'
      Size = 50
    end
    object EmpresasCAMINHO_FOTO_EMP: TStringField
      FieldName = 'CAMINHO_FOTO_EMP'
      Origin = '"EMPRESA"."CAMINHO_FOTO_EMP"'
      Size = 150
    end
    object EmpresasFANTASIA_EMP: TStringField
      FieldName = 'FANTASIA_EMP'
      Origin = '"EMPRESA"."FANTASIA_EMP"'
      Size = 50
    end
    object EmpresasMOSTRAR_SITCLI_PREVENDA: TStringField
    ...
    object EmpresasCADASTRAR_CLIENTE_SEM_CPF: TStringField
